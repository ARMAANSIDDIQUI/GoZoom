                ...
                <div className="container relative z-10 block">
                    <div className="max-w-3xl text-center mx-auto">
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-7xl font-extrabold text-white mb-6 leading-tight" data-aos="fade-up" data-aos-delay="200">
                            Get iOS Expert for <span className="text-gradient">Enterprises.</span>
                        </h1>
                        <p className="text-xl text-blue-100 mb-10 text-shadow-md" data-aos="fade-in" data-aos-delay="500">
                            Our expert iOS developers can help you build custom, scalable, and secure applications.
                        </p>
                        <div className="flex flex-wrap gap-4 justify-center" data-aos="fade-in" data-aos-delay="800">
                            <Link to="/contact" className="px-8 py-4 rounded-full bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-bold hover:shadow-lg hover:shadow-blue-500/30 transition-all hover:-translate-y-1">Enquire Now</Link>
                            <Link to="/about" className="px-8 py-4 rounded-full glass bg-white/10 text-white font-bold hover:bg-white/20 transition-all hover:-translate-y-1 backdrop-blur-md border border-white/20">About Us</Link>
                        </div>
                    </div>
                </div>
            </section>
