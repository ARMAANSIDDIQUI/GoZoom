  ...
  return (
    <div>
        ...
        <div className="container mx-auto px-6 lg:px-16 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="flex-1 text-center lg:text-left mx-auto lg:mx-0" data-aos="fade-right">
              <span className="inline-block py-1 px-3 rounded-full bg-[var(--color-gozoom-blue)]/20 text-[var(--color-gozoom-blue)] border border-[var(--color-gozoom-blue)]/30 font-bold text-sm mb-6 uppercase tracking-wider">AI-Powered Solutions</span>
              <h1 className="text-5xl lg:text-7xl font-extrabold text-white mb-8 leading-tight uppercase">
                Hire Experienced <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-gozoom-blue)] to-[var(--color-gozoom-green)]">Chatbot Developers</span>
              </h1>
            ...
            <div data-aos="fade-right">
              <div className="space-y-6">
                <h2 className="text-3xl md:text-5xl font-bold text-slate-800 leading-tight">
                  Helping Businesses Transform Their Customers Engagement into <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-gozoom-blue)] to-[var(--color-gozoom-green)]">Amazing Experiences</span>
                </h2>
      ...
      <section className="py-24 bg-gradient-to-br from-slate-900 via-[var(--color-gozoom-blue)] to-slate-900 relative overflow-hidden">
        ...
        <div className="container relative z-10 block">
          <div className="text-center mb-16">
            <span className="inline-block py-1 px-3 rounded-full bg-[var(--color-gozoom-blue)]/20 text-[var(--color-gozoom-blue)] border border-[var(--color-gozoom-blue)]/30 font-bold text-sm mb-4 uppercase tracking-wider">Expertise</span>
            <h3 className="text-3xl md:text-5xl font-bold text-white">Our Chatbot Developers <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-gozoom-blue)] to-[var(--color-gozoom-green)]">Specialize In...</span></h3>
          </div>
      ...
      <section className="py-24 bg-slate-50 relative" id="learnMore">
        <div className="container relative z-10 block">
          <div className="text-center mb-16">
            <span className="inline-block py-1 px-3 rounded-full bg-[var(--color-gozoom-blue)]/20 text-[var(--color-gozoom-blue)] font-bold text-sm mb-4">Why Choose Us</span>
            <h3 className="text-3xl md:text-5xl font-bold text-slate-800">Why You Should Choose our <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-gozoom-blue)] to-[var(--color-gozoom-green)]">Chatbot Experts.</span></h3>
          </div>
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center" data-aos="fade-left">
              <div className="glass-card bg-white rounded-3xl p-10 shadow-2xl border border-slate-100 inline-block">
                ...
                <p className="text-2xl font-bold text-slate-800 mb-6">Ask our Chatbot Experts<br /><span className="text-[var(--color-gozoom-blue)]">about their services today!</span></p>
                <Link to="/contact" className="inline-block px-10 py-4 rounded-full bg-gradient-to-r from-[var(--color-gozoom-blue)] to-[var(--color-gozoom-green)] text-white font-bold hover:shadow-lg hover:shadow-[var(--color-gozoom-blue)]/30 transition-all hover:-translate-y-1">Get Started</Link>
              </div>
            </div>
          </div>
        </div>
