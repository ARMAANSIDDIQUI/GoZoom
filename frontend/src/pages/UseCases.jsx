                            ...
                            <div className="relative w-full max-w-[450px] aspect-square animate-float">
                                ...
                                <div className="relative z-10 w-full h-full bg-white/5 border border-white/10 rounded-[3rem] backdrop-blur-md shadow-2xl p-8 flex flex-col items-center justify-center gap-8">
                                    <div className="grid grid-cols-2 gap-8 w-full place-items-center">
                                        <div className="w-24 h-24 rounded-3xl bg-red-500/10 flex items-center justify-center shadow-lg border border-red-500/20"><FaHeartbeat className="w-12 h-12 text-red-500" /></div>
                                        <div className="w-24 h-24 rounded-3xl bg-blue-500/10 flex items-center justify-center shadow-lg border border-blue-500/20"><FaShoppingCart className="w-12 h-12 text-blue-500" /></div>
                                        <div className="w-24 h-24 rounded-3xl bg-emerald-500/10 flex items-center justify-center shadow-lg border border-emerald-500/20"><FaChartLine className="w-12 h-12 text-emerald-500" /></div>
                                        <div className="w-24 h-24 rounded-3xl bg-amber-500/10 flex items-center justify-center shadow-lg border border-amber-500/20"><FaIndustry className="w-12 h-12 text-amber-500" /></div>
                                    </div>
