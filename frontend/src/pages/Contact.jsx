        ...
        <div className="relative z-10 container mx-auto px-6 max-w-7xl">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
            ...
            <div className="w-full lg:w-[45%] text-left">
              ...
              <div className="flex flex-wrap gap-6 justify-center lg:justify-start mb-12" data-aos="fade-up" data-aos-delay="500">
                <div className="flex items-center gap-4 text-blue-200/80">
                  <div className="w-14 h-14 rounded-[1.25rem] bg-white/5 border border-white/10 flex items-center justify-center text-xl">
