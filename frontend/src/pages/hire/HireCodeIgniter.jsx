                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-20">
                        <div className="flex-1 text-center lg:text-left" data-aos="fade-right">
                            ...
                            <div className="flex flex-wrap justify-center lg:justify-start gap-6">
                                <Link to="/contact" className="px-10 py-5 bg-orange-600 text-white font-black text-lg rounded-xl shadow-2xl shadow-orange-600/20 hover:bg-orange-700 hover:-translate-y-1 transition-all flex items-center gap-3 group">
                                    Enquire Now <FaArrowRight className="group-hover:translate-x-1 transition-transform" />
                                </Link>
                                <a href="#speed" className="px-10 py-5 bg-white/5 border border-white/10 text-white font-bold text-lg rounded-xl hover:bg-white/10 transition-all">
                                    Why Speed Matters
                                </a>
                            </div>
                        </div>
